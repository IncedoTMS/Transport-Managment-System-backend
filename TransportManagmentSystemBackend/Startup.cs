...
using TransportManagmentSystemBackend.Core.Data;
...
namespace TransportManagmentSystemBackend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<UserRequestContext>(options => options.UseSqlServer(Configuration.GetConnectionString("TransportManagmentSystem")));
            // Configure Cors.
